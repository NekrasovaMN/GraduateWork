...
3. В IntelliJ IDEA через терминал запущен файл aqa-shop.jar
4. Открыта база данных для проверки записей (например DBeaver)
...
*Ожидаемый результат:* Форма отправлена. Оплата проходит. Выходит сообщение "Успешно. Операция одобрена Банком." Данные об оплате появляются в таблице payment_entity операция со статусом APPROVED
...
3. а) Отправка формы с невалидными данными в поле "Номер карты" (11 арабских цифр) при оплате тура по карте
...
12. а) Отправка формы с невалидными данными в поле "Владелец" (значение на кириллице) при покупке тура по карте
...
13. а) Отправка формы с невалидными данными в поле "Владелец" (цифры, спец символы) при покупке тура по карте
...
14. а) Отправка формы с невалидными данными в поле "Владелец" (один символ на латинице) при покупке тура по карте
...
15. а) Отправка формы с невалидными данными в поле "CVC/CVV"(менее 3х символов) при покупке тура по карте 
...
16. а) Отправка формы с невалидными данными в поле "CVC/CVV" (данные из нулей) при покупке тура по карте
...
17. а) Отправка формы с невалидными данными в поле "CVC/CVV" (более 3х символов) при покупке тура по карте
...
18. а) Отправка формы с пустым полем "Номер карты" при покупке тура по карте
...
19. а) Отправка формы с пустым полем "Месяц" при покупке тура по карте
...
20. а) Отправка формы с пустым полем "Год" при покупке тура по карте
...
21. а) Отправка формы с пустым полем "Владелец" при покупке тура по карте
...
22. а) Отправка формы с пустым полем "CVC/CVV" при покупке тура по карте
...
23. а) Отправка формы с пустыми полями при покупке тура по карте
